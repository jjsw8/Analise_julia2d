...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04/09/2025 às 15:37
...
--
-- Banco de dados: `dados1`
--

-- --------------------------------------------------------

--
-- Estrutura para tabela `recados1`
--

CREATE TABLE `recados1` (
  `id` int(10) NOT NULL,
...
--
-- Índices de tabela `recados1`
--
ALTER TABLE `recados1`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `recados1`
--
ALTER TABLE `recados1`
